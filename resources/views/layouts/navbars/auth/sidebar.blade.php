    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('scrapeurl') ? 'active' : 'scrapeurl') }}" href="{{ url('scrapeurl') }}">
          ...
          <span class="nav-link-text ms-1">High Ranking Words ENG</span>
        </a>
      </li>


      <li class="nav-item">
        <a class="nav-link {{ (Request::is('scrapeurlar') ? 'active' : 'scrapeurlar') }}" href="{{ url('scrapeurlar') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>shop </title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <span class="nav-link-text ms-1">High Ranking Words AR</span>
        </a>
      </li>
