			...
			<div class="row">
			  <div class="col-8">
				<div class="numbers">
				  ...
				  <h5 class="font-weight-bolder mb-0">
					  @php echo $seo_difficulty @endphp
          ...
          <div class="container border-radius-lg">
            <div class="row">
              <div class="col-3 py-3 ps-0">
                ...
                <h4 class="font-weight-bolder">	@php echo $organic_keywords @endphp
				</h4>
              ...
              <div class="col-3 py-3 ps-0">
                ...
                <h4 class="font-weight-bolder">@php echo $ctr_scope @endphp</h4>
                <div class="progress w-75">
              ...
              <div class="col-3 py-3 ps-0">
                ...
                <h4 class="font-weight-bolder">@php echo $off_page_difficulty @endphp</h4>
                <div class="progress w-75">
              ...
              <div class="col-3 py-3 ps-0">
                ...
                <h4 class="font-weight-bolder">@php echo $on_page_difficulty @endphp</h4>
                <div class="progress w-75">
