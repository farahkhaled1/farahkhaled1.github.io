...
# stemmed_words = []
# for word in filtered_sentence:
#     stemmed_word = p_stemmer.stem(word)
...
#   # Filter out Arabic keywords
#     # Filter out words with less than three letters
#     d = d[d['word'].str.len() >= 3]

#     # Filter out Arabic keywords
#     arabic_chars = set(['\u0621', '\u0622', '\u0623', '\u0624', '\u0625', '\u0626', '\u0627', '\u0628', '\u0629', '\u062a', '\u062b', '\u062c', '\u062d', '\u062e', '\u062f', '\u0630', '\u0631', '\u0632', '\u0633', '\u0634', '\u0635', '\u0636', '\u0637', '\u0638', '\u0639', '\u063a', '\u0640', '\u0641', '\u0642', '\u0643', '\u0644', '\u0645', '\u0646', '\u0647', '\u0648', '\u0649', '\u064a', '\u064b', '\u064c', '\u064d', '\u064e', '\u064f', '\u0650', '\u0651', '\u0652'])
#     d = d[~d['word'].apply(lambda x: any(c in arabic_chars for c in x))]

#     # Filter out words that are entirely numeric
#     d = d[~d['word'].str.isnumeric()]
    
#     return d.sort_values(by=['frequency'], ascending=True).head(20)
...
# # -*- coding: utf-8 -*-# # -*- coding: utf-8 -*-# # -*- coding: utf-8 -*-# # -*- coding: utf-8 -*-# # -*- coding: utf-8 -*-# # -*- coding: utf-8 -*-# # -*- coding: utf-8 -*-
# # -*- coding: utf-8 -*-
# # -*- coding: utf-8 -*-
# # -*- coding: utf-8 -*-
# # -*- coding: utf-8 -*-
...
def tf_idf_analysis(keyword):
    ...
    # return d.sort_values(by=['frequency'], ascending=True).head(10)


    # d = d[(d['word'].str.isalpha())].head(10)
