            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form role="form" method="POST" action=" <?php echo e(route('convert')); ?> ">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.user_type.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/farahkhaled/Desktop/seopro/resources/views/imageopt.blade.php ENDPATH**/ ?>