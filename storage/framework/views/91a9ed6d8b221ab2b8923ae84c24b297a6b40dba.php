          ...
          <div class="container border-radius-lg">
            <div class="row">
              <div class="col-3 py-3 ps-0">
                ...
                <h4 class="font-weight-bolder">	<?php echo $organic_keywords ?>
				</h4>
              ...
              <div class="col-3 py-3 ps-0">
                ...
                <h4 class="font-weight-bolder"><?php echo $ctr_scope ?></h4>
                <div class="progress w-75">
              ...
              <div class="col-3 py-3 ps-0">
                ...
                <h4 class="font-weight-bolder"><?php echo $off_page_difficulty ?></h4>
                <div class="progress w-75">
              ...
              <div class="col-3 py-3 ps-0">
                ...
                <h4 class="font-weight-bolder"><?php echo $on_page_difficulty ?></h4>
                <div class="progress w-75">
...
<?php echo $__env->make('layouts.user_type.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/University/Graduation Project/seopro/resources/views/analyzer.blade.php ENDPATH**/ ?>