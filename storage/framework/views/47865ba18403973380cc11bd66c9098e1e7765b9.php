          ...
          <div class="row">
            <div class="col-xl-8 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card">
                ...
                <div class="card-body">
                  <form method="POST" action="<?php echo e(route('store_niche_ar')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
    ...
    <div class="col-lg-8 col-md-6 mb-md-0 mb-4" style="margin-left:180px">
      <div class="card">
        <div class="card-header pb-0">
          ...
          <?php
$lastNiche = \App\Models\Niche_ar::getLastNiche();
          ...
          <div class="table-responsive">
            <table class="table align-items-center mb-0">
              ...
              <tbody>
                ...
                <?php $__currentLoopData = \App\Models\Keyword_ar::getKeywords(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyword): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td>
...
<?php echo $__env->make('layouts.user_type.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\last semester\final project\seopro\resources\views/keyword_ar.blade.php ENDPATH**/ ?>