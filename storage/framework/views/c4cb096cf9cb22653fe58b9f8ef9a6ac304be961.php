          ...
          <div class="table-responsive">
            <table class="table align-items-center mb-0">
              ...
              <tbody>
                ...
                <?php $__currentLoopData = \App\Models\Analytics::getAnalytics(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $analytics): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>

                    <td>
                        <div class="d-flex px-2 py-1">
                            <div class="d-flex flex-column justify-content-center">
                              <a href="<?php echo e(route('analyticshistorydetails', ['id' => $analytics->id])); ?>">
...
<?php echo $__env->make('layouts.user_type.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/farahkhaled/Desktop/seopro/resources/views/analytics/analyticshistory.blade.php ENDPATH**/ ?>