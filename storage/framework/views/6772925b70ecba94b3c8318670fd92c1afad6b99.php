<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-end me-3 rotate-caret " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="<?php echo e(route('dashboard')); ?>">
        ...
        <span class="ms-1 font-weight-bold">SEOPro Dashboard</span>
    </a>
  </div>
...
<?php /**PATH F:\last semester\final project\seopro\resources\views/layouts/navbars/auth/sidebar-rtl.blade.php ENDPATH**/ ?>