...
<div class="row mt-4">
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="d-flex flex-column h-100">
              <p class="mb-1 pt-2">Built by SEOPro Team</p>
              <h4 class=" font-weight-bolder">SEOPro Dashboard</h4>
              <p class="  mb-4 text-bold">From keywords, rank analysis, and blog idea generators to a range of other powerful tools, we got has everything you need to optimize your website's performance.</p>
 ...
 <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url('../assets/img//curved-images/white-curved.jpeg');">
          ...
          <div class="row">
            ...
            <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
              <div class=" border-radius-lg h-100">
                <img src="../assets/img/shapes/waves-white.svg" class="position-absolute h-100 w-50 top-0 d-lg-block d-none" alt="waves">
                <div class="position-relative d-flex align-items-center justify-content-center h-100">
                  <img class=" w-xxl-100 w-100 border-radius-lg" src="../assets/img/5.png" alt="rocket">
                </div>
              </div>
            </div>
          </div>
...
<?php echo $__env->make('layouts.user_type.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\last semester\final project\seopro\resources\views/dashboard.blade.php ENDPATH**/ ?>