    ...
    <div class="card h-10 p-3">
      ...
      <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url('../assets/img/curved-images/curved0.jpg');">
        ...
        <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
          <form method="post" action="<?php echo e(route('magiceditor')); ?>">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.user_type.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/farahkhaled/Desktop/seopro-1/resources/views/magiceditor.blade.php ENDPATH**/ ?>